...
const faqGeral: FaqItem[] = [
  { q: 'O que é o Atalaia?', a: 'O Atalaia é a plataforma digital de saúde e cuidado da Rede Amor a Dois, a serviço da Igreja do Amor. Ele organiza relatórios, supervisões, dados de células e informações pastorais em um só lugar — de forma simples e acessível.' },
  ...
  { q: 'Como o Atalaia cuida da saúde da rede?', a: 'Organizando informações, mantendo o histórico e garantindo que nenhuma célula fique sem acompanhamento. O Atalaia ajuda a Igreja do Amor a cuidar melhor de cada vida com excelência e ordem.' },
