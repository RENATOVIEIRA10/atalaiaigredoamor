...
export interface WhatsappBotStatus {
  ...
  last_report_saved_at?: string | null;
  database_write_ok?: boolean | null;
  database_write_at?: string | null;
  has_qr?: boolean;
...
export interface WhatsappOpsOverview {
  ...
  metrics: {
    ...
    manual_sent_total: number;
    last_24h_total: number;
    cells_total: number | null;
    reports_current_week_total: number;
    missing_reports_total: number | null;
    events_total: number;
  };
