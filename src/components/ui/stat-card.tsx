...
export function StatCard({ icon: Icon, label, value, subtitle, trend, className, onClick }: StatCardProps) {
  const content = (
    <Card
      variant="glass"
    ...
    >
      <CardContent className="p-5">
        <div className="flex items-start justify-between">
          ...
          <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-xl bg-primary/10 ring-1 ring-primary/20 transition-all duration-300 group-hover:bg-primary/15 group-hover:ring-primary/30 group-hover:shadow-[0_0_16px_hsl(var(--primary)/0.15)]">
